/**
 * Page de détails d'une action (Collaborateur)
 * Affichage complet + formulaire de mise à jour du statut
 * SÉCURITÉ : Seules les actions assignées AU collaborateur sont accessibles
 */
...
export default async function ActionDetailPage({ params }: PageProps) {
  ...
  // Récupérer l'action avec SÉCURITÉ RENFORCÉE : doit être assignée AU collaborateur
