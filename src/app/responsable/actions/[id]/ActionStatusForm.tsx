...
/**
 * Formulaire de mise à jour du statut d'une action (Responsable)
 */

import { useState, useTransition } from 'react';
import { updateActionStatut } from '@/app/actions/responsable';
...
export function ActionStatusForm({ actionId, currentStatut }: ActionStatusFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      const result = await updateActionStatut({
        actionId,
